      ...
      <section className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="relative grid grid-cols-1 gap-4 mx-auto w-full h-full justify-items-center">
          <Image
            ...
            width={400}
            height={600}
            className="rounded-2xl md:absolute top-20 left-5  object-cover z-10 hover:z-100 hover:rotate-10 hover:scale-105 transition-all duration-300"
          />
          <Image
            src="/images/chef.jpg"
            ...
            width={400}
            height={600}
            className="rounded-2xl md:absolute bottom-20 right-0 object-cover z-20 hover:z-100 hover:rotate-10 hover:scale-105 transition-all duration-300"
          />
        </div>
      </section>
    </Container>
